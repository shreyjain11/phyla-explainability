...
class CorrectPhylaMambaLRPAnalyzer:
    ...
    def analyze_sequences(
        ...
        with torch.no_grad():
            ...
            position_weights_concat = torch.cat(position_weights, dim=0)
            ...
            weighted_memory = torch.bmm(attn_avg, memory_rep)
            ...
            multilayer_cls = (layer_stack * layer_weights[:, None, None, None]).sum(dim=0)
